# Shot-clock proxy validation — 2018-19
...
- Proxy field-goal attempts: **219,458**
- NBA.com field-goal attempts: **218,279** (+0.54% difference)
- Proxy shots with no reconstructable clock: **5,915** (2.70%)
...
|---|---|---|---|
| 24-22 | 44.0% | 56.5% | -12.5 pp |
| 22-18 | 52.4% | 51.8% | +0.6 pp |
| 18-15 | 46.9% | 46.9% | +0.0 pp |
| 15-7 | 46.8% | 45.9% | +0.9 pp |
| 7-4 | 44.3% | 43.7% | +0.6 pp |
| 4-0 | 41.1% | 34.8% | +6.3 pp |

- Correlation of the two FG% curves across ranges: **r = 0.5338**
- Mean absolute FG% deviation: **3.50 pp**
...
| 22-18 | 11.1% | 14.2% | -3.1 pp |
| 18-15 | 11.8% | 17.7% | -5.9 pp |
| 15-7 | 49.5% | 47.4% | +2.2 pp |
| 7-4 | 13.9% | 9.1% | +4.9 pp |
| 4-0 | 12.9% | 8.7% | +4.3 pp |

- Total variation distance: **0.1130** (0 = identical, 1 = disjoint)
...
|---|---|---|
| right-closed (default) | 0.1130 | 85.7% |
| left-closed | 0.0710 | 88.9% |
...
- Dead-ball resets (made_fg, final_ft): n=82,540, mean **8.80s** remaining, 19.9% at <=4s
- Live-ball resets (def_reb, off_reb): n=89,227, mean **13.48s** remaining, 5.8% at <=4s
- Gap: **-4.68s** in the wrong direction
