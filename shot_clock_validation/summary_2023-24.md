# Shot-clock proxy validation — 2023-24
...
- Proxy field-goal attempts: **218,702**
- NBA.com field-goal attempts: **216,060** (+1.22% difference)
- Proxy shots with no reconstructable clock: **6,428** (2.94%)
...
|---|---|---|---|
| 24-22 | 48.8% | 56.9% | -8.1 pp |
| 22-18 | 55.3% | 54.4% | +0.9 pp |
| 18-15 | 47.5% | 47.8% | -0.3 pp |
| 15-7 | 48.0% | 47.4% | +0.6 pp |
| 7-4 | 45.6% | 44.5% | +1.0 pp |
| 4-0 | 42.5% | 36.9% | +5.6 pp |

- Correlation of the two FG% curves across ranges: **r = 0.8124**
...
| 22-18 | 11.0% | 12.7% | -1.7 pp |
| 18-15 | 11.1% | 16.3% | -5.1 pp |
| 15-7 | 49.3% | 49.1% | +0.2 pp |
| 7-4 | 14.5% | 10.1% | +4.4 pp |
| 4-0 | 13.4% | 8.7% | +4.6 pp |

- Total variation distance: **0.0924** (0 = identical, 1 = disjoint)
...
|---|---|---|
| right-closed (default) | 0.0924 | 86.4% |
| left-closed | 0.0604 | 89.4% |
...
- Dead-ball resets (made_fg, final_ft): n=84,708, mean **8.52s** remaining, 20.9% at <=4s
- Live-ball resets (def_reb, off_reb): n=87,680, mean **13.45s** remaining, 5.5% at <=4s
- Gap: **-4.93s** in the wrong direction
